(function () {
    ...
    angular
        .module('app.configuracion.confobjects')
        .controller('ConfobjectsController', ConfobjectsController);

    /** @ngInject */
    function ConfobjectsController(api, $http, FileuploadService, TextForms, ProjectService, LocalstorageService) {
      var vm = this;
